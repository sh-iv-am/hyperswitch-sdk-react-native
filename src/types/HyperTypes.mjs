...
function parseResponseFromNativeModule(responseDict) {
  ...
  var code = Core__Option.getOr(Js_json.decodeString(Core__Option.getOr(Js_dict.get(responseDict, "code"), null)), "");
  var message = Core__Option.getOr(Js_json.decodeString(Core__Option.getOr(Js_dict.get(responseDict, "message"), null)), "");
  var status = Core__Option.getOr(Js_json.decodeString(Core__Option.getOr(Js_dict.get(responseDict, "status"), null)), "");
  return {
          type_: type_,
          code: code,
          message: message,
