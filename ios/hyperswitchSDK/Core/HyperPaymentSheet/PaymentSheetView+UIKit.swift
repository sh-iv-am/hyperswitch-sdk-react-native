...
internal extension PaymentSheet {
    ...
    private func presentWithRootView(from presentingViewController: UIViewController, rootView: UIView?, completion: @escaping (PaymentSheetResult) -> ()) {
        ...
        RNFabricManager.sharedInstance.responseHandler = self
